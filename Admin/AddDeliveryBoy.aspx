<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterAdmin1.Master" AutoEventWireup="true" CodeBehind="AddDeliveryBoy.aspx.cs" Inherits="OnlineClothing.Admin.AddDeliveryBoy" %>
         ...
         <asp:Panel ID="pnlgrid" runat="server" style="padding-left: 20px; padding-right: 19px;">
                  ...
                  <asp:GridView ID="gvShop" runat="server" AutoGenerateColumns="false"  CssClass="table-bordered"  
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Sr.No">
                            <ItemTemplate>
                                <asp:Label ID="lblSrNo" runat="server" Text='<%# Container.DataItemIndex + 1 %>'></asp:Label>
                                  <asp:Label ID="lblDeliveryBoyId" runat="server" Visible="false" Text='<%# Bind("DeliveryBoyId") %>'></asp:Label>
                        ...
                        <asp:TemplateField HeaderText="Image">
                         ...
                         <asp:TemplateField HeaderText="DeliverBoy Name">
                            <ItemTemplate>
                                <asp:Label ID="lblCatName" runat="server" Text='<%# Bind("DeliverBoyName") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Mob No">
                            <ItemTemplate>
                                <asp:Label ID="lblMarathiCatName" runat="server" Text='<%# Bind("MobNo") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="" HorizontalAlign="Left" />
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Adhar No">
                            <ItemTemplate>
                                <asp:Label ID="lblMarathiCatName" runat="server" Text='<%# Bind("DeliverBoyAddr") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="" HorizontalAlign="Left" />
                        </asp:TemplateField>
                          <asp:TemplateField HeaderText="Email">
                            <ItemTemplate>
                                <asp:Label ID="lblCatName" runat="server" Text='<%# Bind("Email") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="" HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Bank AccNo">
                            <ItemTemplate>
                                <asp:Label ID="lblMarathiCatName" runat="server" Text='<%# Bind("BankAccNo") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="" HorizontalAlign="Left" />
                        </asp:TemplateField>
                         <%-- <asp:TemplateField HeaderText="Category Name">
                            <ItemTemplate>
                                <asp:Label ID="lblCatName" runat="server" Text='<%# Bind("IFSCcode") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="" HorizontalAlign="Left" />
                        </asp:TemplateField>--%>
                        ...
                        <%--  <asp:TemplateField HeaderText="Category Name">
                            <ItemTemplate>
                                <asp:Label ID="lblCatName" runat="server" Text='<%# Bind("DeliverBoyRegNo") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle Width="" HorizontalAlign="Left" />
                        </asp:TemplateField>--%>
                   ...
                   <td>
                    <div class="col-lg-16" style="text-align:right;">
                          <asp:Button ID="AddNewSh" runat="server" Text="Register New DeliveryBoy" CssClass="btn btn-red btn-darken-2" ForeColor="White" Font-Bold="true" onclick="AddNewSh_Click" />
                        </div>
                   </td>
                   </tr>       
                </table>
            ...
            <div id="myTabContent" class="tab-content ">
             <div class="col-lg-16" style="padding-left: 20px; padding-right: 20px;">
                ...
                <div class="form-group col-lg-16">
                    <asp:Label ID="lblSName" runat="server" Text="DeliveryBoy Name" Font-Size="15px"></asp:Label>
                    <asp:TextBox ID="txtSName" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
                <div class="form-group col-lg-16">
                    <asp:Label ID="lblSRegNo" runat="server" Text="Registration No" Font-Size="15px"></asp:Label>
                    <asp:TextBox ID="txtSRegNo" runat="server" CssClass="form-control"></asp:TextBox>
                </div>
                <div class="form-group col-lg-16">
                    <asp:Label ID="lblShopAddr" runat="server" Text="Address" Font-Size="15px"></asp:Label>
                ...
                <div class="form-group col-lg-16">
                    <asp:Label ID="lblOwnAdhar" runat="server" Text="Adhar No" Font-Size="15px"></asp:Label><br />
