<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashBoard.aspx.cs" Inherits="OnlineClothing.Admin.DashBoard" %>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                   ...
                   <li>
                  <div id="divLinks" runat="server" style="font-size:18px">  </div>
                       </li>
                    </ul>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Copyright &copy; 2020 Kalakruti
                    </div>
                    <div class="col-sm-6 text-right">
                        Designed by <a href="https://dotcominfotech.co.in/">DotCom</a>
                    </div>
                </div>
            </div>
        </footer>
