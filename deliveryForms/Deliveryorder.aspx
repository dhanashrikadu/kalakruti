<%@ Page Title="" Language="C#" MasterPageFile="~/deliveryForms/masterDeliveryBoy.Master" AutoEventWireup="true" CodeBehind="Deliveryorder.aspx.cs" Inherits="OnlineClothing.deliveryForms.Deliveryorder" %>
                            ...
                            <div class="caption"><h4><small>
                             ...
                             <asp:Label runat="server" ID="Label11" Font-Size="18px" ForeColor="White" Style="font-family: Celias,Helvetica"
                               ...
                               <div  style="background-color:Green;padding-top:10px; height:35px;  text-align:center">
                                   <asp:Button ID="Button1" runat="server" Font-Size="15px" ToolTip='<%# Eval("Deli_ID") %>' BackColor="Green" Font-Bold="true" OnClick="btn_PickupConfirmed" ForeColor="White" BorderStyle="None" Style="font-family: Celias,Helvetica" Text="PICKUP CONFIRMED" />
                               </div></div>
                               </div>
                           </div>
                       </div>
